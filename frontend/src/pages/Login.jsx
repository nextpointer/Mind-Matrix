...
export const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(false); // Stop loading after the request is done (success or failure)
    }
  };
      ...
      <div id="login-page-container">
        <div className="login-box">
          ...
          <div className="login-section">
            ...
            {loading ? (
              <Loader/>// Replace with a spinner or other loader
            ) : (
              <form className="form" onSubmit={handleSubmit}>
                ...
                <p className="p">
                  ...
                  <span className="span"><Link to={"/user/register"}>Sign Up</Link></span>
                </p>
